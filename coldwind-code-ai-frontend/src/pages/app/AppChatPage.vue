...
.preview-section.collapsed .preview-header h3 {
  display: none; /* 隐藏标题 */
}

.preview-section.collapsed .preview-actions .ant-btn:not(.collapse-btn) {
  display: none; /* 隐藏其他按钮 */
}
...
@media (max-width: 1200px) {
  .preview-section:not(.collapsed) {
    width: 55vw; /* 中等屏幕时稍微缩小 */
    min-width: 450px;
  }
}
